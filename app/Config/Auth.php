...
class Auth extends \Myth\Auth\Config\Auth
{
    ...
    public $viewLayout = 'Views/template/layout';
    public $dashboard = 'Views/dashboard/template/layout';
    ...
    public $userActivators = [
        'Myth\Auth\Authentication\Activators\EmailActivator' => [
            'fromEmail' => 'support@yohplanner.com',
            'fromName' => 'Yohplanner.org',
        ],
    ];

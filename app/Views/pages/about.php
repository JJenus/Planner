    ...
    <?= $this->section('main') ?>
            <section class="section-header pb-8 pb-lg-13 mb-4 mb-lg-6 bg-warning text-white">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-12 col-md-8 text-center">
                            <h1 class="display-2 mb-3">Who is Rocket for?</h1>
                ...
                <div class="container mt-n7 mt-lg-n13 z-2">
                    <div class="row justify-content-center">
                        <div class="col-12 col-lg-4">
                            <div class="card shadow-soft bg-white border-light animate-up-3 text-gray py-4 mb-5 mb-lg-0">
                                <div class="card-header text-center pb-0">
                                    <div class="icon icon-shape icon-shape-warning rounded-circle mb-3"><span class="fas fa-bullhorn"></span></div>
                                ...
                                <div class="card-body">
                                    <ul class="list-group">
                                        <li class="list-group-item d-flex px-0 pt-0 pb-2">
                                            <div class="icon icon-sm icon-success mr-4"><i class="far fa-check-circle"></i></div>
                            ...
                            <div class="card shadow-soft bg-white border-light animate-up-3 text-gray py-4 mb-5 mb-lg-0">
                                <div class="card-header text-center pb-0">
                                    <div class="icon icon-shape icon-shape-warning rounded-circle mb-3">
                                        <span class="far fa-lightbulb"><span></span></span>
                                    </div>
                        ...
                        <div class="col-12 col-lg-4">
                            <div class="card shadow-soft bg-white border-light animate-up-3 text-gray py-4 mb-5 mb-lg-0">
                                <div class="card-header text-center pb-0">
                                    <div class="icon icon-shape icon-shape-warning rounded-circle mb-3"><span class="fas fa-receipt"></span></div>
                        ...
                        <div class="timeline timeline-six px-3 px-lg-0">
                            <div class="row no-gutters">
                                ...
                                <div class="col-lg-1 text-center flex-column d-none d-lg-flex">
                                    ...
                                    <span class="d-none d-lg-block m-4 h4 lh-200 dot-separator bg-soft shadow-soft border border-light text-warning">1</span>
                                    <div class="row h-50">
                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="col-lg-1 text-center flex-column d-none d-lg-flex">
                                    ...
                                    <span class="m-4 h4 lh-200 dot-separator bg-soft shadow-soft border border-light text-warning">2</span>
                                    <div class="row h-50">
                                        <div class="col middle-line">&nbsp;</div>
                                        <div class="col">&nbsp;</div>
                                    </div>
                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="col-lg-1 text-center flex-column d-none d-lg-flex">
                                    ...
                                    <span class="m-4 h4 lh-200 dot-separator bg-soft shadow-soft border border-light text-warning">3</span>
                                    <div class="row h-50">
                                        <div class="col middle-line">&nbsp;</div>
                                        <div class="col">&nbsp;</div>
                                    </div>
                            ...
                            <div class="row no-gutters">
                                <div class="col-lg py-2">
                                    <div class="card left-timeline-card bg-soft shadow-soft border-light p-3">
                                        <div class="card-body p-4">
                                            ...
                                            <p>
                                                We recommend you to start using the interactive console of the Developer Portal and getting familiar with the different endpoints of the API with the documentation. Here’s an interesting read
                                                to start consuming the API using curl: 9 uses for cURL worth knowing.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-1 text-center flex-column d-none d-lg-flex">
                                    ...
                                    <span class="m-4 h4 lh-200 dot-separator bg-soft shadow-soft border border-light text-warning">4</span>
                                    <div class="row h-50">
                                        <div class="col">&nbsp;</div>
                                        <div class="col">&nbsp;</div>
                                    </div>
                ...
                <div class="container">
                            ...
                            <div class="customer-testimonial d-flex mb-5">
                                ...
                                <div class="content-wrapper bg-soft shadow-soft border border-light rounded position-relative p-4">
                                    <div class="d-flex mb-4">
                                        <span class="text-warning mr-2"><i class="star fas fa-star"></i></span> <span class="text-warning mr-2"><i class="star fas fa-star"></i></span>
                                        <span class="text-warning mr-2"><i class="star fas fa-star"></i></span> <span class="text-warning mr-2"><i class="star fas fa-star"></i></span>
                                        <span class="text-warning mr-2"><i class="star fas fa-star"></i></span>
                                    </div>
                                    <p class="mt-2">
                                        "We use Rocket mainly for its site explorer, and it’s immensely improved how we find link targets. We use it both for getting quick analysis of a site, as well as utilizing its extensive index when we
                                        want to dive deep."
                                    </p>
                                    <h6>- James Curran <small class="ml-0 ml-md-2">General Manager Spotify</small></h6>
                                </div>
                            </div>
                            <div class="customer-testimonial d-flex mb-5">
                                ...
                                <div class="content-wrapper bg-soft shadow-soft border border-light rounded position-relative p-4">
                                    ...
                                    <h6>- Richard Thomas <small class="ml-0 ml-md-2">Chief Engineer Apple</small></h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-lg-6 pt-lg-6">
                            <div class="customer-testimonial d-flex mb-5">
                                ...
                                <div class="content-wrapper bg-soft shadow-soft border border-light rounded position-relative p-4">
                                    ...
                                    <h6>- Jose Evans <small class="ml-0 ml-md-2">Chief Engineer Apple</small></h6>
                                </div>
                            </div>
                            <div class="customer-testimonial d-flex mb-lg-5">
                                ...
                                <div class="content-wrapper bg-soft shadow-soft border border-light rounded position-relative p-4">
                                    ...
                                    <h6>- Richard Thomas <small class="ml-0 ml-md-2">Designer Google</small></h6>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col text-center">
                            <a href="testimonials.html" class="btn btn-warning animate-up-2">
                                <span class="mr-2"><i class="fas fa-book-open"></i></span> See all stories
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 text-center mb-5">
                            ...
                            <a href="#" class="icon icon-lg text-gray mr-3"><span class="fab fa-mailchimp"></span> </a><a href="#" class="icon icon-lg text-gray mr-3"><span class="fab fa-cpanel"></span> </a>
                            <a href="#" class="icon icon-lg text-gray mr-3"><span class="fab fa-dhl"></span> </a><a href="#" class="icon icon-lg text-gray mr-3"><span class="fab fa-github-alt"></span> </a>
                            <a href="#" class="icon icon-lg text-gray mr-3"><span class="fab fa-aws"></span> </a><a href="#" class="icon icon-lg text-gray"><span class="fab fa-node"></span></a>
                        </div>
                        <div class="col-12 text-center">
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                    <div class="modal-content py-4">
                        ...
                        <div class="modal-header text-center text-black">
                            <div class="col-12"><h4 class="px-lg-6">Our 30-days trial gives you full access to all tools and features of your chosen plan.</h4></div>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-12 col-lg-6 text-left">
                                    <div class="form-check card border-light p-3">
                                        <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios1" value="option1" />
                                        <label class="form-check-label" for="exampleRadios1">
                                            <span class="h6 text-black d-block">Free</span> <span class="small text-gray">30 days for free, then $99/mo</span>
                                            <span class="text-gray mt-3 d-block p">Suits freelance marketers and solopreneurs. Get full access to Ahrefs' core tools and features with enough data to do SEO for your personal projects.</span>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-12 col-lg-6 text-left">
                                    <div class="form-check card border-light p-3">
                                        ...
                                        <label class="form-check-label" for="exampleRadios2">
                                            <span class="h6 text-black d-block">Premium</span> <span class="small text-gray">200$/mo</span>
                                            <span class="text-gray mt-3 d-block p">
                                                Perfect for SEO consultants and in-house marketers. Get everything in Lite with more features and increased data limits to research a large number of websites.
                                            </span>
                                        </label>
                                    </div>
                                </div>
                        ...
                        <div class="modal-footer border-0 text-center">
                            <div class="col text-gray">
                                <a href="checkout.html" class="btn btn-warning mb-4">Continue</a>
                                <p class="small mb-0">
                                    You can upgrade, downgrade, or cancel your subscription anytime.<br />
